...
public class PlatoFuerte extends Restaurante {
    
    public PlatoFuerte(String TipoDeBebida, int NumeroDePlatillos, String TiempoDeComida, String PrincipalesOrdenes) {
